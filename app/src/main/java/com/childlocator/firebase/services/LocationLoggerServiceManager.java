...
//  public static final String LOG_TAG = "LLoggerServiceManager";
//
//  @Override
...
//      mPrefs = context.getSharedPreferences(Constants.APP_PACKAGE_NAME, Context.MODE_PRIVATE);
//
//      /*
...
//          Log.e(LOG_TAG, "Could not start service " + comp.toString());
//        }
//      }
//
//    } else {
