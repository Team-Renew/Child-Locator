...
public class BackgroundLocationService extends IntentService implements
  ...
  private static final String LOG_TAG = "BackgroundLocationSrvc";
  ...
  public void onCreate() {
    ...
    // Set the fastest update interval (seconds)
    ...
    Toast.makeText(this, "BackgroundLocationService created.", Toast.LENGTH_LONG).show();
    Log.d(LOG_TAG, "BackgroundLocationService created." + latitude);
  }
  ...
  public void onLocationChanged(Location location) {
    ...
    if (currentUserDbUrl != null) {
      currentUserDbUrl.child(Constants.NODE_LATITUDE).setValue(latitude);
      currentUserDbUrl.child(Constants.NODE_LONGITUDE).setValue(longitude);
    }
